...
package com.huawei.hicampus.claw.ai.provider.openai;
...
public class OpenAIResponsesProvider implements ApiProvider {
    ...
    public OpenAIResponsesProvider(com.huawei.hicampus.claw.ai.env.ProviderConfigResolver providerConfigResolver) {
    ...
    private AssistantMessageEventStream doStream(
            ...
            @Nullable com.huawei.hicampus.claw.ai.types.ThinkingLevel reasoning) {
    ...
    ResponseCreateParams buildParams(
        ...
        if (model.reasoning()) {
            if (reasoning != null && reasoning != com.huawei.hicampus.claw.ai.types.ThinkingLevel.OFF) {
    ...
    private static String mapReasoningEffort(com.huawei.hicampus.claw.ai.types.ThinkingLevel level) {
        return switch (level) {
            case MINIMAL -> "low";
            case LOW -> "low";
            case MEDIUM -> "medium";
    ...
    static List<Tool> convertTools(List<com.huawei.hicampus.claw.ai.types.Tool> tools) {
