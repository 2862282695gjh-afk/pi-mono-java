...
package com.huawei.hicampus.claw.ai.provider.mistral;
...
public class MistralProvider implements ApiProvider {
    ...
    private final com.huawei.hicampus.claw.ai.env.ProviderConfigResolver providerConfigResolver;

    public MistralProvider(com.huawei.hicampus.claw.ai.env.ProviderConfigResolver providerConfigResolver) {
    ...
    private void emitThinkingDelta(
        ...
        if (!state.thinkingStarted) {
            ...
            eventStream.push(new com.huawei.hicampus.claw.ai.stream.AssistantMessageEvent.ThinkingStartEvent(
        ...
        eventStream.push(new com.huawei.hicampus.claw.ai.stream.AssistantMessageEvent.ThinkingDeltaEvent(
    ...
    private void finishMistralStream(MistralStreamState state, Model model, AssistantMessageEventStream eventStream) {
        if (state.thinkingStarted && !state.currentThinking.isEmpty()) {
            ...
            eventStream.push(new com.huawei.hicampus.claw.ai.stream.AssistantMessageEvent.ThinkingEndEvent(
    ...
    private String resolveApiKey(
            com.huawei.hicampus.claw.ai.env.ResolvedProviderConfig providerConfig, @Nullable SimpleStreamOptions options) {
