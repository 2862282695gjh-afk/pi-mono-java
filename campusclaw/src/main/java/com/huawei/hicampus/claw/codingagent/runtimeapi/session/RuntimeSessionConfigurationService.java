...
public class RuntimeSessionConfigurationService {
    ...
    private List<com.huawei.hicampus.claw.codingagent.runtimeapi.dto.RuntimeEntryDTO> modelChangeEntries(
            RuntimeSessionDTO current, Model model, String reason, OffsetDateTime updatedAt) {
        List<com.huawei.hicampus.claw.codingagent.runtimeapi.dto.RuntimeEntryDTO> entries = new ArrayList<>();
