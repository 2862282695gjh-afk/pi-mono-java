...
public class CampusClawAiService {
    ...
    private com.huawei.hicampus.claw.ai.provider.AiProvider resolveManagedProvider(Model model) {
        Objects.requireNonNull(model, "model must not be null");
