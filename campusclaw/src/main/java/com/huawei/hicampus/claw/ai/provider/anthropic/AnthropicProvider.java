...
import com.huawei.hicampus.claw.ai.env.ResolvedProviderConfig;
...
import com.huawei.hicampus.claw.ai.types.ImageContent;
...
import com.huawei.hicampus.claw.ai.types.ThinkingBudgets;
...
public class AnthropicProvider implements ApiProvider {
    ...
    static List<MessageParam> convertMessages(List<Message> messages, boolean enableCaching) {
        ...
        for (Message message : messages) {
            if (message instanceof com.huawei.hicampus.claw.ai.types.UserMessage um) {
                result.add(convertUserMessage(um));
            } else if (message instanceof AssistantMessage am) {
                result.add(convertAssistantMessage(am));
            } else if (message instanceof com.huawei.hicampus.claw.ai.types.ToolResultMessage tr) {
    ...
    private static MessageParam convertUserMessage(com.huawei.hicampus.claw.ai.types.UserMessage um) {
    ...
    private static MessageParam convertToolResult(com.huawei.hicampus.claw.ai.types.ToolResultMessage tr) {
