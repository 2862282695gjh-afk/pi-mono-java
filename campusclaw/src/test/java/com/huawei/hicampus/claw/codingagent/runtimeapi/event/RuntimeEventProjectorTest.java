...
import com.huawei.hicampus.claw.agent.event.ToolExecutionUpdateEvent;
...
class RuntimeEventProjectorTest {
    ...
    private static AssistantMessage assistant(
            Model model, List<com.huawei.hicampus.claw.ai.types.ContentBlock> content, StopReason reason, long timestamp) {
