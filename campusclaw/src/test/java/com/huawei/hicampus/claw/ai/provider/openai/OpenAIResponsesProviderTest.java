...
class OpenAIResponsesProviderTest {
    ...
    class ToolConversion {
        ...
        void convertsToolWithSchema() {
            ...
            var tool = new com.huawei.hicampus.claw.ai.types.Tool("read", "Read a file", params);
        ...
        void convertsMultipleTools() {
            ObjectNode params = MAPPER.createObjectNode();
            var tools = List.of(
                    new com.huawei.hicampus.claw.ai.types.Tool("read", "Read file", params),
                    new com.huawei.hicampus.claw.ai.types.Tool("write", "Write file", params));
    ...
    class ParameterBuilding {
        ...
        void setsToolsWhenPresent() {
            ...
            var tools = List.of(new com.huawei.hicampus.claw.ai.types.Tool("bash", "Run commands", toolParams));
