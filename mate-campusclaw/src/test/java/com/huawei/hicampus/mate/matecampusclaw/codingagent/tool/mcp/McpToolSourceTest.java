...
class McpToolSourceTest {
    ...
    void mapsListedMcpToolsUsingServerNamePrefix() {
        ...
        var contributions = source.load(com.huawei.hicampus.mate.matecampusclaw.codingagent.tool.catalog.ToolSourceContext.defaults());
    ...
    void skipsMcpServersWhenMcpToolsAreDisabled() {
        var client = new FakeMcpClient(List.of(tool("echo")));
        var source = new McpToolSource(List.of(config("filesystem")), ignored -> client);
        var context = new com.huawei.hicampus.mate.matecampusclaw.codingagent.tool.catalog.ToolSourceContext(
    ...
    void reusesMcpClientAcrossRefreshesAndClosesItWhenDisabled() {
        ...
        var enabled = com.huawei.hicampus.mate.matecampusclaw.codingagent.tool.catalog.ToolSourceContext.defaults();
        var disabled = new com.huawei.hicampus.mate.matecampusclaw.codingagent.tool.catalog.ToolSourceContext(
                java.nio.file.Path.of("."), java.nio.file.Path.of("user-tools"), true, true, true, false);
