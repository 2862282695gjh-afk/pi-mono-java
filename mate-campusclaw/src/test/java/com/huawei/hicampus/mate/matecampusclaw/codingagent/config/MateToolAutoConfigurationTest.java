...
class MateToolAutoConfigurationTest {
    ...
    void factoryPairsShareOneCachePerSessionAndIsolateAcrossSessions() {
        runner.run(context -> {
            ...
            var stateA = factory.createSession(
                    "agent-1", Map.of(), com.huawei.hicampus.mate.matecampusclaw.codingagent.common.client.mate.MateCredentials.empty());
            var stateB = factory.createSession(
                    "agent-2", Map.of(), com.huawei.hicampus.mate.matecampusclaw.codingagent.common.client.mate.MateCredentials.empty());
    ...
    void mateErrorPropagatesThroughPipelineAsIsError() {
        ...
        CallMateTool callMateTool = new com.huawei.hicampus.mate.matecampusclaw.codingagent.tool.mate.MateToolsetFactory(client)
                .createSession(
                        "agent-1", Map.of(), com.huawei.hicampus.mate.matecampusclaw.codingagent.common.client.mate.MateCredentials.empty())
                .createCallTool();
