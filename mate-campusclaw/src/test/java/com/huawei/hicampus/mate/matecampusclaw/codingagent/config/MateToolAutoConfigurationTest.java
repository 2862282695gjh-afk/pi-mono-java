...
class MateToolAutoConfigurationTest {
    ...
    void bothToolsShareOneSessionCacheBean() {
        runner.run(context -> {
            assertThat(context).hasSingleBean(com.huawei.hicampus.mate.matecampusclaw.codingagent.tool.mate.MateToolSessionCache.class);
            assertThat(context.getBean(CallMateTool.class))
                    .hasFieldOrPropertyWithValue(
                            "sessionCache",
                            context.getBean(com.huawei.hicampus.mate.matecampusclaw.codingagent.tool.mate.MateToolSessionCache.class));
