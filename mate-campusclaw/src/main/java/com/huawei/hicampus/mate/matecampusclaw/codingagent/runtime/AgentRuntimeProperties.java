...
public record AgentRuntimeProperties(
        URI baseUrl, Path agentsRoot, Duration connectTimeout, Duration requestTimeout, int maxResponseBytes) {
    ...
    public AgentRuntimeProperties(URI baseUrl, Path agentsRoot, Duration connectTimeout, Duration requestTimeout) {
        this(baseUrl, agentsRoot, connectTimeout, requestTimeout, DEFAULT_MAX_RESPONSE_BYTES);
    }
