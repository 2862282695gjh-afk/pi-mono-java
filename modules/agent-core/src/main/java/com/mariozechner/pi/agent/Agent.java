package com.mariozechner.pi.agent;
...
import com.mariozechner.pi.agent.event.ToolExecutionEndEvent;
import com.mariozechner.pi.agent.event.ToolExecutionStartEvent;
import com.mariozechner.pi.agent.loop.AgentLoop;
import com.mariozechner.pi.agent.loop.AgentLoopConfig;
...
public class Agent {
    ...
    public Agent(PiAiService piAiService) {
        this(
            piAiService,
            new AgentState(),
