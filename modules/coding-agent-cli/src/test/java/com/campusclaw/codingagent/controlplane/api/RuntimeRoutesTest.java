...
class RuntimeRoutesTest {
    ...
    private Set<com.campusclaw.agent.controlplane.domain.RuntimeCapability> toCapabilities(Set<String> names) {
        Set<com.campusclaw.agent.controlplane.domain.RuntimeCapability> out = new java.util.HashSet<>();
        for (String n : names) {
            out.add(com.campusclaw.agent.controlplane.domain.RuntimeCapability.valueOf(n));
        }
        return out;
    }
}
