...
class TransientAgentRunnerTest {
    ...
    private static StubSession stubSession(List<com.campusclaw.ai.types.Message> history) {
    ...
    private static final class StubSession extends AgentSession {
        ...
        StubSession(List<com.campusclaw.ai.types.Message> history) {
            super(
                    mock(CampusClawAiService.class),
                    new ModelRegistry(),
                    mock(SystemPromptBuilder.class),
        ...
        @Override
        public List<com.campusclaw.ai.types.Message> getHistory() {
            return history;
        }
    }
}
