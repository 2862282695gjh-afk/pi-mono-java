...
import com.mariozechner.pi.tui.component.SelectList;
...
public class TreeSelectorOverlay implements Component, Focusable {
    ...
    public TreeSelectorOverlay(List<com.mariozechner.pi.ai.types.Message> messages) {
    ...
    private List<TreeItem> buildItems(List<com.mariozechner.pi.ai.types.Message> messages) {
