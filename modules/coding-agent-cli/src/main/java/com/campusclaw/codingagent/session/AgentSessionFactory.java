...
import com.campusclaw.codingagent.tool.builtin.ToolAssemblyContext;
...
public class AgentSessionFactory {
    ...
    private static java.util.function.Supplier<AgentTool> contextualSupplier(
            java.util.function.BiFunction<PreparedAgentRuntime, com.campusclaw.ai.types.Model, AgentTool> factory,
            PreparedAgentRuntime runtime,
            com.campusclaw.ai.types.Model model) {
